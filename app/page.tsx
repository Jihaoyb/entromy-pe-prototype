    ...
    <main className="bg-brand-bg text-brand-ink">
      ...
      <section id={whyChoose.id} className="section-shell scroll-mt-28 py-12 lg:py-14">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="body-copy mx-auto mt-5 max-w-4xl">{whyChoose.subtitle}</p>
        </div>

        <div className="mx-auto mt-12 grid max-w-6xl gap-x-12 gap-y-8 md:grid-cols-2">
          {whyChoose.points.map((point) => (
            <article key={point.heading} className="flex gap-4">
              ...
              <div>
                <h3 className="text-2xl font-medium text-brand-ink">{point.heading}</h3>
