...
export function BenefitCard({ iconSrc, title, description }: BenefitCardProps) {
  return (
    <article className="h-full rounded-md border border-brand-line bg-brand-panel p-7 text-center shadow-card">
      ...
      <p className="mt-3.5 text-[15px] leading-[1.55] text-brand-muted">{description}</p>
    </article>
  );
}
